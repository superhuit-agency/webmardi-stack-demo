...
export default async function Page({
	...
	// ⚠️ Never call directly searchParams['whatever'] in here, otherwise it will force the page into dynamic rendering at request time
	if (Object.keys(searchParams).length) {
		isDraft = searchParams['preview-draft'] === 'true';
